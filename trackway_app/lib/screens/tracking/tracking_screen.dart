      ...
      builder: (context, isLoading, _) {
        return ValueListenableBuilder<String?>(
          ...
          builder: (context, errorMsg, _) {
            ...
            return ValueListenableBuilder<bool>(
              valueListenable: _engine.activeJourneyNotifier,
              builder: (context, activeJourney, _) {
                // If active journey is reported true, but no GPS position log exists yet
                if (activeJourney && _engine.gpsLocationNotifier.value == null) {
                  return Scaffold(
                    backgroundColor: AppTheme.bgMint,
                    appBar: AppBar(title: Text("Tracking Bus #${widget.busId}")),
                    body: Center(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: const Icon(Icons.location_searching_rounded, size: 54, color: AppTheme.warningAmber),
                            ),
                            const SizedBox(height: 20),
                            Text(
                              errorMsg ?? "Waiting for driver GPS location signal...",
                  ...
                  appBar: AppBar(
                    ...
                    title: ValueListenableBuilder<Map<String, dynamic>?>(
                      ...
                      builder: (context, etaData, _) {
                        ...
                        final titleText = (busName != null && busNum != null && busName.toString().isNotEmpty)
                            ? "$busName ($busNum)"
                            : "Bus #${widget.busId}";
                        return Text(
                          titleText,
                    ...
                    children: [
                      ...
                      ValueListenableBuilder<LatLng?>(
                        ...
                        builder: (context, initialPos, _) {
                          final centerPos = initialPos ?? const LatLng(12.0369964, 75.3600476);
                          return FlutterMap(
                                ...
                                ValueListenableBuilder<Map<String, dynamic>?>(
                                  ...
                                  builder: (context, etaData, _) {
                                    ...
                                    for (int i = 0; i < stops.length; i++) {
                                      ...
                                      final arrivalTimeRaw = stop["arrival_time"] as String? ?? "";
                                      final arrivalTime = TimeUtils.formatLocalClockTime(arrivalTimeRaw);
                                                          ...
                                                          Column(
                                                            ...
                                                            children: [
                                                              ...
                                                              Builder(builder: (context) {
                                                                final arrivalTimeRaw = s["arrival_time"] as String? ?? "";
                                                                final arrivalTime = TimeUtils.formatLocalClockTime(arrivalTimeRaw);
                            ...
                            : Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        Container(
                                          ...
                                          child: const Icon(Icons.bus_alert_rounded, color: AppTheme.textSecondary, size: 28),
                                        ),
                                        const SizedBox(width: 14),
                                        Expanded(
                                          child: Column(
                                    ...
                                    const Text(
                                      "This bus is currently inactive and not running any journey. Live tracking will automatically resume when the driver starts a new journey.",
