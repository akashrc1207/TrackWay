                              ...
                              child: Row(
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: bus.status == "Active" ? AppTheme.successBg : Colors.grey.shade200,
                                      borderRadius: BorderRadius.circular(8),
                                    ),
                                    child: Text(
                                      bus.status.isNotEmpty ? bus.status : "Inactive",
                                      style: TextStyle(
                                        color: bus.status == "Active" ? AppTheme.successGreen : Colors.grey.shade700,
                                        fontSize: 11,
                                        fontWeight: FontWeight.bold,
                                      ),
                                    ),
